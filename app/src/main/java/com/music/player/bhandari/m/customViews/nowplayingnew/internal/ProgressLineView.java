...
public class ProgressLineView extends ImageView {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        //make sure touch has been made on progress line
        if (event.getAction() == MotionEvent.ACTION_DOWN
                && !(tanAngle < BEGIN_PROGRESS_DEGREE || tanAngle > END_PROGRESS_DEGREE)
                && (touchPointDistanceToCenter > radius - mAllowedTouchRadius && touchPointDistanceToCenter < radius + mAllowedTouchRadius)
               ) {
