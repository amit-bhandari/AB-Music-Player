...
public class UserPlaylistLibraryAdapter extends RecyclerView.Adapter<UserPlaylistLibraryAdapter.MyViewHolder>
    ...
    public UserPlaylistLibraryAdapter(Context context){
        //create first page for folder fragment
        this.context=context;
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        inflater=LayoutInflater.from(context);
        headers = PlaylistManager.getInstance(context).getUserCreatedPlaylistList();
    ...
    public void onClick(View view, int position) {
        ...
        switch (view.getId()){
            ...
            case R.id.menuPopup:
                ...
                inflater.inflate(R.menu.user_playlist_menu, popup.getMenu());
                popup.show();
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            UserPlaylistLibraryAdapter.this.onClick(view,getLayoutPosition());
        }
    }
}
