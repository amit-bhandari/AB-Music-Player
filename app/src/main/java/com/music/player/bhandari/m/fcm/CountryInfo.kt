...
class CountryInfo : Thread(Runnable {
    var country: String = MyApp.Companion.getPref().getString(MyApp.Companion.getContext()!!
    ...
    if (country == "") {
        ...
        MyApp.Companion.getPref().edit()
            .putString(MyApp.Companion.getContext()!!.getString(R.string.pref_user_country),
                country).apply()
    }
})